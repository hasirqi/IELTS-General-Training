import { curriculum as previousCurriculum } from "./course-bank-batch05";
import { curriculumBatch06 } from "./curriculum-batch-06";
import type { CourseLesson } from "./curriculum-v2";

export type { CourseLesson };
export const curriculum: CourseLesson[] = [...previousCurriculum, ...curriculumBatch06];
